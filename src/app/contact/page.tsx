            ...
            <div className="lg:col-span-7 bg-white border border-slate-200 rounded-3xl p-8 shadow-xs">
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full py-3 px-6 rounded-lg surface-teal text-white font-semibold text-sm shadow-xs  hover:border-brand-teal-200 hover:scale-[1.01] active:scale-[0.99] transition-all flex items-center justify-center gap-2 group"
                  >
                ...
                <div className="py-10 text-center space-y-4">
                  <div className="w-14 h-14 bg-brand-aqua/15 border border-brand-teal-200 rounded-full flex items-center justify-center mx-auto text-brand-teal">

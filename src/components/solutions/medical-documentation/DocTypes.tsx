...
const docTypes = [
  {
    ...
    highlights: [
      "Practice-specific section order",
      "Vitals pulled into Objective",
      "Assessment linked to ICD-10",
    ],
    sample: [
      {
        label: "S",
        text: "42yo F presents for annual exam and hypertension follow-up. Reports mild fatigue, otherwise well.",
      },
      {
        label: "O",
        text: "BP 128/82, HR 74, BMI 26.1. Cardiopulmonary exam unremarkable.",
      },
      {
        label: "A",
        text: "Essential hypertension, controlled. Routine preventive care.",
      },
      {
        label: "P",
        text: "Continue Benicar 20mg daily. Lipid panel today. Return in 6 months.",
      },
    ],
  },
  {
    ...
    highlights: [
      "Prior-visit context carried forward",
      "Interval change surfaced first",
      "Medication adjustments tracked",
    ],
    sample: [
      {
        label: "Interval",
        text: "Day 3 post-admission. Dyspnea improved; ambulating in hallway without desaturation.",
      },
      {
        label: "Exam",
        text: "Afebrile. Lungs with improved air entry bilaterally. No new edema.",
      },
      {
        label: "Assessment",
        text: "CHF exacerbation responding to diuresis. Net negative 2.4L since admission.",
      },
      {
        label: "Plan",
        text: "Transition IV to oral furosemide. Ambulate TID. Anticipate discharge in 24-48h.",
      },
    ],
  },
  {
    ...
    highlights: [
      "Reason for referral stated up front",
      "Impression separated from plan",
      "Letter-ready formatting",
    ],
    sample: [
      {
        label: "Referral",
        text: "Referred by Dr. Patel for evaluation of exertional chest tightness.",
      },
      {
        label: "Findings",
        text: "ECG normal sinus rhythm. Stress echo negative for inducible ischemia.",
      },
      {
        label: "Impression",
        text: "Non-cardiac chest pain. Likely musculoskeletal in origin.",
      },
      {
        label: "Recommendation",
        text: "No further cardiac workup indicated. Trial of NSAIDs. Return if symptoms change.",
      },
    ],
  },
  {
    ...
    highlights: [
      ...
      "Follow-up instructions explicit",
    ],
    sample: [
      {
        label: "Admission",
        text: "Admitted 07/24 with acute decompensated heart failure.",
      },
      {
        label: "Course",
        text: "Diuresed with IV furosemide. Symptoms resolved by day 4. No arrhythmia observed.",
      },
      {
        label: "Discharge Meds",
        text: "Entresto 49/51mg BID, furosemide 40mg daily, metoprolol succinate 50mg daily.",
      },
      {
        label: "Follow-up",
        text: "Cardiology in 7 days. Daily weights. Return for weight gain >3lb in 48h.",
      },
    ],
  },
  {
    ...
    highlights: [
      "25+ specialty-tuned models",
      "Discipline-specific exam fields",
      "Specialty coding cross-checks",
    ],
    sample: [
      {
        label: "Exam",
        text: "Right knee flexion 115 degrees, extension full. No effusion. Stable to varus/valgus stress.",
      },
      {
        label: "Imaging",
        text: "Weight-bearing X-ray: Grade II osteoarthritis, medial compartment narrowing.",
      },
      {
        label: "Assessment",
        text: "Primary osteoarthritis, right knee, medial compartment predominant.",
      },
      {
        label: "Procedure",
        text: "Intra-articular corticosteroid injection performed under sterile technique.",
      },
    ],
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-lg text-slate-600 mt-4 leading-relaxed font-normal">
            One documentation engine across the full range of clinical note
            types.
          </p>
        </div>

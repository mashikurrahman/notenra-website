...
const contrasts = [
  {
    ...
    notenra:
      "A board-certified reviewer checks every note before it reaches you",
  },
  {
...
const compliance = [
  ...
  },
  {
    ...
    detail: "Never used to train third-party models",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600 mt-4 leading-relaxed font-normal">
            Most AI scribes stop at the draft. The difference is what happens
            after it.
          </p>
        </div>
          ...
          {compliance.map((c, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-6 border border-slate-200 shadow-xs hover:border-brand-teal-200 hover:border-brand-teal-200 transition-all"
              >

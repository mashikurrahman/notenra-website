...
const steps = [
  {
    ...
    detail: {
      ...
      points: ["Multi-speaker separation", "Specialty acoustic tuning", "Works on desktop, tablet, or mobile"],
    },
  },
  {
    number: "02",
    ...
    detail: {
      ...
      points: ["Practice-specific note structure", "ICD-10 and CPT suggested inline", "Draft ready in under 45 seconds"],
    },
  },
  {
    number: "03",
    ...
    detail: {
      ...
      points: ["Board-certified clinical reviewers", "Every note checked, not sampled", "Corrections feed back into your templates"],
    },
  },
  {
    number: "04",
    ...
    detail: {
      ...
      points: ["Bi-directional FHIR / HL7 sync", "Codes travel with the note", "Full audit trail retained"],
    },
  },
];
...
export function DocProcess() {
  ...
  return (
    <section id="process" className="py-24 sm:py-32 bg-slate-50 border-y border-slate-200/60 relative overflow-hidden scroll-mt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-5 rounded-2xl border transition-all duration-300 ${
                    isActive
                      ? "bg-white border-[#0E7C93] shadow-lg shadow-[#0E7C93]/10"
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 transition-colors ${
                        isActive
                          ? "bg-gradient-cyan text-white shadow-md shadow-[#0E7C93]/25"
                    ...
                    <div className="min-w-0">
                      <div className="flex items-center gap-2 mb-1 flex-wrap">
                        ...
                        <span
                          className={`text-[10px] font-bold px-2 py-0.5 rounded-full border ${
                            s.highlight
                              ? "bg-[#0E7C93]/10 text-[#0E7C93] border-[#0E7C93]/25"
                      ...
                      <h3 className="text-lg font-bold text-[#1B3F60] mb-1">{s.title}</h3>
          ...
          <div className="lg:col-span-7 lg:sticky lg:top-28">
            <div className="bg-surface-teal rounded-3xl p-8 relative overflow-hidden shadow-lg shadow-[#0E7C93]/10 border border-[#4ACCCE]/40 min-h-105">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex items-center gap-3 pb-4 border-b border-[#0E7C93]/15">
                    <div className="w-11 h-11 rounded-xl bg-gradient-cyan flex items-center justify-center text-white shadow-md shadow-[#0E7C93]/25">
                    ...
                    <div>
                      ...
                      <h4 className="text-xl font-bold text-[#1B3F60]">{step.detail.heading}</h4>
                    </div>
                  </div>

                  <p className="text-sm text-slate-600 leading-relaxed">{step.detail.body}</p>
                  ...
                  {/* Progress rail */}
                  <div className="flex items-center justify-between pt-5 border-t border-[#0E7C93]/15">
                    <span className="text-xs text-slate-500">Step {active + 1} of {steps.length}</span>
                      ...
                      {steps.map((s, dot) => (
                        <button
                          ...
                          className={`h-2 rounded-full transition-all ${
                            dot === active ? "w-8 bg-gradient-cyan" : "w-2 bg-[#1B3F60]/15 hover:bg-[#0E7C93]/40"
                          }`}
                        />
                      ))}
                    </div>

...
export const SOLUTIONS = [
  {
    ...
    blurb: "Ambient AI drafting with certified clinical review, delivered EHR-ready.",
    icon: FileText,
  ...
  },
  {
    slug: "coding",
    title: "Coding",
    blurb: "Autonomous ICD-10, CPT, and HCC assignment with compliance cross-checks.",
    icon: Cpu,
    href: "/#coding",
  },
  {
    slug: "billing",
    title: "Billing",
    blurb: "Pre-claim scrubbing that catches missing modifiers before submission.",
    icon: CreditCard,
    href: "/#billing",
  },
  {
          ...
          {related.map((s, idx) => {
            ...
            return (
              ...
              >
                <Link
                  href={s.href}
                  className="group relative flex flex-col h-full bg-white rounded-3xl p-8 border border-slate-200/90 shadow-sm hover:shadow-lg hover:border-[#0E7C93]/50 transition-all duration-300"
                >
                  ...
                  <h3 className="text-xl font-bold text-[#1B3F60] mb-2 group-hover:text-[#0E7C93] transition-colors">
                    {s.title}
                  </h3>
                  ...
                  <span className="mt-6 inline-flex items-center gap-1.5 text-sm font-bold text-[#0E7C93]">
                    Explore
